            ...
            <li key={person.email} className={'flex justify-between gap-x-6 py-2 '+ (person.facial=="1"?'bg-green-200':'bg-red-200')}
              ...
              <div className="flex min-w-0 gap-x-4 px-2">
                ...
                <div className="min-w-0 flex-auto">
                  ...
                  <p className="mt-1 truncate text-xs leading-5 text-gray-500">{person.cpf}</p>
                  <p className="mt-1 truncate text-xs leading-5 text-gray-500">{person.celular}</p>
                  <p className="mt-1 truncate text-xs leading-5 text-gray-500">{person.email}</p>
                  <p className="mt-1 truncate text-xs leading-5 text-gray-500">Atualizado: {person.updated}</p>
                </div>
              </div>
            </li>
          ))}
