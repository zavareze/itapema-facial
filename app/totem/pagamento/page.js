    ...
    return (
        <div className="isolate bg-white dark:bg-slate-900 px-6 py-12 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
                ...
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Escolha a Forma de Pagamento</h2>
            ...
            <div className="mt-4 grid grid-cols-8 gap-4 w-full mb-8">
                <div className="rounded-xl bg-indigo-600 p-16 text-center font-semibold text-white shadow-xl text-7xl mb-8 col-span-2">
                    Débito
                </div>
                <div className="rounded-xl bg-indigo-600 p-16 text-center font-semibold text-white shadow-xl text-7xl mb-8 col-span-2">
                    Crédito
                ...
                <div className="rounded-xl bg-red-600 p-16 text-center font-semibold text-white shadow-xl text-7xl mb-8 col-span-2">
                    Cancelar
                </div>
            </div>
