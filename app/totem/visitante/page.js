    ...
    return (
        <div className="isolate bg-white dark:bg-slate-900 px-6 py-12 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto text-center h-[530px]">
                ...
                <h2 className="text-6xl font-bold tracking-tight text-gray-900 dark:text-white">Pagamento Estacionamento Visitante</h2>
                <p className="mt-2 text-3xl leading-8 text-gray-600 dark:text-slate-300">
                    Leia o QR Code localizado abaixo e a esquerda
                </p>
            </div>
            ...
            <div className="rounded-xl bg-green-600 p-16 text-center font-semibold text-white shadow-xl text-6xl my-8">
