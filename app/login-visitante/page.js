...
async function verifyCPF(cpf) {
  const res = await fetch(
    `https://facial.parquedasaguas.com.br/visitante/check`,
    {
      method: "POST",
      headers: {
...
async function getLogin(celular, cpf) {
  ...
  else localStorage.setItem("visitantes", "[]");
  if (json["pedidos"])
    localStorage.setItem("pedidos", JSON.stringify(json["pedidos"]));
  else localStorage.setItem("pedidos", "[]");
  return json;
}
export default function Login() {
  ...
  const login = async () => {
    if (agreed) {
      ...
      alert(
        "Você deve concordar com a política de privacidade antes de entrar"
      );
    }
  };
  return (
    <div className="isolate bg-white dark:bg-slate-900 px-6 py-12 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <img
          src="https://compre.parquedasaguas.com.br/img/cpa.png"
      ...
      <form action={login} className="mx-auto mt-8 max-w-xl sm:mt-20">
            ...
            <div className="flex h-6 items-center">
              ...
              >
                <span className="sr-only">
                  Estou de acordo com a polícica de privacidade
                </span>
                <span
                  aria-hidden="true"
                  className={classNames(
        ...
        <div className="pt-4">
          Ou caso ainda não tenha cadastro{" "}
          <div className="text-indigo-600 cursor-pointer font-bold" onClick={() => setShowModal(true)}>Cadastre-se aqui</div>
        </div>
        <div className="pt-8">
          <small>
            ...
            <div className="relative w-auto my-6 mx-auto w-full max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-semibold">Cadastro Visitante</h3>
                  <button
                ...
                <div className="relative p-4 flex-auto">
                  <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    <div>
                      <label
                        htmlFor="cpf"
                        className="block text-sm font-semibold leading-4 text-gray-900"
                      >
                        CPF
                      </label>
                      <div className="mt-2">
