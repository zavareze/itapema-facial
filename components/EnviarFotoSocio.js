export default function EnviarFotoSocio({matricula, setLoading, setResult}) {
    const handleUploadFile = (event) => {
        ...
        img.onload = () => {
            ...
            const body = { matricula, image: dst.toDataURL() };
            upload(body);
        }
    ...
    return (<div className="col-span-2 grid grid-cols-2 gap-x-2">
        <div className="text-center font-bold text-red-500 col-span-2">
